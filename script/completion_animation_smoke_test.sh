...
STATE_FILE="$(mktemp "${TMPDIR:-/tmp}/StillgridSudoku-complete-state.XXXXXX.json")"
SAVE_FILE="$(mktemp "${TMPDIR:-/tmp}/StillgridSudoku-complete-save.XXXXXX.json")"
LEADERBOARD_FILE="$(mktemp "${TMPDIR:-/tmp}/StillgridSudoku-complete-leaderboard.XXXXXX.json")"
