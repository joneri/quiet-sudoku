...
MARKETING_VERSION="${STILLGRID_SUDOKU_MARKETING_VERSION:-1.0}"
BUILD_NUMBER="${STILLGRID_SUDOKU_BUILD_NUMBER:-1}"
MIN_SYSTEM_VERSION="15.0"
SIGNING_IDENTITY="${STILLGRID_SUDOKU_SIGNING_IDENTITY:-}"
AD_HOC_SIGN="${STILLGRID_SUDOKU_AD_HOC_SIGN:-0}"
ENTITLEMENTS_PATH="${STILLGRID_SUDOKU_ENTITLEMENTS_PATH:-}"
PROVISIONING_PROFILE_PATH="${STILLGRID_SUDOKU_PROVISIONING_PROFILE_PATH:-}"
