...
DISPLAY_NAME="Stillgrid Sudoku"
BUNDLE_ID="${STILLGRID_SUDOKU_BUNDLE_ID:-${MACSUDOKU_BUNDLE_ID:-se.jonaseriksson.macSudoku}}"
MARKETING_VERSION="${STILLGRID_SUDOKU_MARKETING_VERSION:-${MACSUDOKU_MARKETING_VERSION:-1.01}}"
BUILD_NUMBER="${STILLGRID_SUDOKU_BUILD_NUMBER:-${MACSUDOKU_BUILD_NUMBER:-7}}"
MIN_SYSTEM_VERSION="15.0"
SIGNING_IDENTITY="${STILLGRID_SUDOKU_SIGNING_IDENTITY:-${MACSUDOKU_SIGNING_IDENTITY:-}}"
AD_HOC_SIGN="${STILLGRID_SUDOKU_AD_HOC_SIGN:-${MACSUDOKU_AD_HOC_SIGN:-0}}"
ENTITLEMENTS_PATH="${STILLGRID_SUDOKU_ENTITLEMENTS_PATH:-${MACSUDOKU_ENTITLEMENTS_PATH:-}}"
PROVISIONING_PROFILE_PATH="${STILLGRID_SUDOKU_PROVISIONING_PROFILE_PATH:-${MACSUDOKU_PROVISIONING_PROFILE_PATH:-}}"
...
DEFAULT_ENTITLEMENTS="$ROOT_DIR/Config/StillgridSudoku.entitlements"
GENERATED_ENTITLEMENTS="$DIST_DIR/$APP_NAME.generated.entitlements"
APP_ICON_SOURCE="$ROOT_DIR/Config/StillgridSudoku.icns"
APP_ICON_NAME="StillgridSudoku.icns"
