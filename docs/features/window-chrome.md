Purpose: Keep Quiet Sudoku visually calm while still behaving like a normal macOS window during review and everyday use.
...
Inputs/outputs: SwiftUI creates the window scene in `/Users/jonaseriksson/dev-stuff/GitHub/macSudoku/Sources/QuietSudoku/App/QuietSudokuApp.swift`, and `/Users/jonaseriksson/dev-stuff/GitHub/macSudoku/Sources/QuietSudoku/Support/FloatingWindowConfigurator.swift` applies AppKit-level window tuning after the window exists.
...
Related files: `/Users/jonaseriksson/dev-stuff/GitHub/macSudoku/Sources/QuietSudoku/App/QuietSudokuApp.swift`, `/Users/jonaseriksson/dev-stuff/GitHub/macSudoku/Sources/QuietSudoku/Support/FloatingWindowConfigurator.swift`
